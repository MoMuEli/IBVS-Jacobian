...
def joint_velocities(pose, points):
    if pose != None:
        if points != None:
            ...
            desired_points = [96.40369045377518, -88.57089060440595, 768, 203.65279608360007, 73.20655243833554, 806,
                              9.640369045377518, 22.59461495010356, 815, 279.57070231594804, -37.055168518169836, 780]
